...
test('root helper writes sanitized quotas and preserves successful values on failure', async () => {
    ...
    const env = { ...process.env, PI_DASHBOARD_RUNUSER_BINARY: fakeRunuser, PI_DASHBOARD_RCLONE_BINARY: fakeRunuser, PI_DASHBOARD_PASSWORD_COMMAND: '', PI_DASHBOARD_PROVIDERS: providers, PI_DASHBOARD_CLOUD_CACHE: cache, PI_DASHBOARD_RCLONE_CONFIG: rcloneConfig };
